...
if(isset($_REQUEST['testuser']))
{
    $uinfo = array('uname'=>$_REQUEST['testuser'], 'gn'=>$_REQUEST['testuser'], 'sn'=>'(TestGuest)', 'email'=>'', 'isAdmin'=>false, 'sessionCreator'=>false, 'user'=>false);
}
else
...
else
{
    ...
    else
    {
        ...
        if($thisSession->questionMode == 0)
        {
	        ...
	        {
	            header( "Refresh: 20; url={$serverURL}?sessionID={$thisSession->id}" );
